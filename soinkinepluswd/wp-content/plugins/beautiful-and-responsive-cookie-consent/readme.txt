...
Free and beautiful Cookie Consent Banner to make your website compliant. Google Consent Mode v2 support. Not loading any files from 3rd party servers.

== Description ==
A free and beautiful way to get a Cookie Banner without loading any external resources from 3rd parties and Google Consent Mode v2 support. Customize it to match your compliance requirements and website layout. This Banner is super responsive and highly customizable. You want to make sure your banner always works? See here: [banner-test](https://beautiful-cookie-banner.com/articles/cookie-banner-test-monitor/)
...
= Key Features =
 ...
 - API for Settings with premium add-on.
 - auto block support with premium add-on.
 - Google Consent Mode v2, including new ad_personalization and ad_user_data with premium add-on: [How to implement Consent Mode v2](https://beautiful-cookie-banner.com/documentation/cookie-consent-premium-add-on-documentation/google-consent-mode-v2-implementation-example/)
